...
export class UsersController {
  ...
  @Get('with-relations')
  async findWithRelations(): Promise<SuccessResponseDto<User[]>> {
    const users = await this.usersService.findWithRelations();
    return new SuccessResponseDto('Users with orders and payments retrieved', users);
  }
